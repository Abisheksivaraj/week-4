...
console.log(swapVariables("Abishek", "Full Stack Developer"));
...
console.log(isValidEmail('abisheksivaraj2001@email.com'));
...
function reverseWordsInSentence(sentence) {
  ...
  console.log(reverseWordsInSentence("abishek Here"));
